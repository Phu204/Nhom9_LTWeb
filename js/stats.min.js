(function() {
    ...
    function ct() {
        ...
        n.postData(k, {
            ...
            value: Bizweb.checkout.total_price,
            content_ids: Bizweb.checkout.line_items.map(function(n) {
                return n.id
            }),
            phone: Bizweb.checkout.billing_address.phone,
            city: Bizweb.checkout.billing_address.city,
            country: Bizweb.checkout.billing_address.country_code
        }, v, e);
                ...
                case "/cart/add.js":
                    if (t.xhr.responseText) {
                        ...
                        n.postData(y, {
                            ...
                            session_id: c,
                            visitor_id: l,
                            variant_id: n.getParamValue("variantId", t.body),
                            action: "add_to_cart",
                            reference_site: s,
                            origin_reference_site: h,
                            current_site: a,
                        ...
                        new URL(location.href).pathname === "/search" && n.postData(y, {
                            store_id: o,
                            session_id: c,
                            visitor_id: l,
                            variant_id: n.getParamValue("variantId", t.body),
                    ...
                    break;
                case "/cart/change.js":
                    n.getParamValue("quantity", t.body) === "0" && n.postData(y, {
                        store_id: o,
                        session_id: c,
                        visitor_id: l,
                        variant_id: n.getParamValue("variantId", t.body),
    ...
    XMLHttpRequest.prototype.open = function(n, t) {
        return this._url = t, this._method = n, ot.apply(this, arguments)
    };
    XMLHttpRequest.prototype.send = function(n) {
        var t = new nt(this, this._url, this._method, n);
        return this.addEventListener ? this.addEventListener("readystatechange", t.onReadyStateChange.bind(t), !1) : (t.oldOnReadyStateChange = this.onreadystatechange, this.onreadystatechange = t.onReadyStateChange), st.call(this, n)
    };
    tt = window.fetch;
            ...
            try {
                switch (data.url) {
                    case "/cart/add.js":
                        ...
                        break;
                    case "/cart/change.js":
                        n.getParamValue("quantity", query) === "0" && n.postData(y, {
                            store_id: o,
                            session_id: c,
                            visitor_id: l,
                            variant_id: n.getParamValue("variantId", data.body),
